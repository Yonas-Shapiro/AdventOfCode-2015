...
def getBestScore(info):
        ...
        for j in range(100):
            ...
            for k in range(100):
                ...
                for l in range(100):
                    ...
                    # Ensuring the 500 calory requirement is met
                    if info[0]["calories"]*i + info[1]["calories"]*j + info[2]["calories"]*k + info[3]["calories"]*l != 500: continue
    ...
    # Sorting to find the highest, then returning the highest
    scores.sort()
    return scores[-1]
...
# Getting the best score and printing out the result
